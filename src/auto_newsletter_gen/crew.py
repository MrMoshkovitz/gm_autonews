...
from auto_newsletter_gen.tools.research import SearchAndContents, FindSimilar, GetContents
...
@CrewBase
class AutoNewsletterGenCrew:
    """Auto NewsletterGen crew"""
    ...
    @crew
    def crew(self) -> Crew:
        """Creates the Auto NewsletterGen crew"""
        return Crew(
