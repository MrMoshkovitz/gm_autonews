...
class AutoNewsletterGenUI:
    ...
    def load_html_template(self):
        with open("/Users/galmoshkovitz/Code/Private/AutoNews_NoCrew/gm_autonews/src/auto_newsletter_gen/config/newsletter_template.html", "r") as file:
    ...
    def generate_newsletter(self, topic, personal_message):
        ...
        return AutoNewsletterGenCrew().crew().kickoff(inputs=inputs)
